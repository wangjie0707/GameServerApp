...
/// DBModel
/// </summary>
public partial class Role_ItemDBModel : MFAbstractSQLDBModel<Role_ItemEntity>
{
    #region Role_ItemDBModel 私有构造
    /// <summary>
    /// 私有构造
    /// </summary>
    private Role_ItemDBModel()
    {
    ...
    private static Role_ItemDBModel instance = null;
    public static Role_ItemDBModel Instance
    {
        get
        {
            if (instance == null)
    ...
    protected override IList<string> ColumnList
    {
        get
        {
            if (_ColumnList == null)
            {
                _ColumnList = new List<string> { "Id", "Status", "RoleId", "CreateTime", "UpdateTime", "ItemId" };
            }
            return _ColumnList;
        }
    }
    ...
    /// <returns></returns>
    protected override SqlParameter[] ValueParas(Role_ItemEntity entity)
    {
        SqlParameter[] parameters = new SqlParameter[] {
                ...
                new SqlParameter("@ItemId", entity.ItemId) { DbType = DbType.Int32 },
    ...
    /// <returns></returns>
    protected override Role_ItemEntity GetEntitySelfProperty(IDataReader reader, DataTable table)
    {
        Role_ItemEntity entity = new Role_ItemEntity();
        foreach (DataRow row in table.Rows)
        {
            ...
            switch (colName.ToLower())
            {
                ...
                case "updatetime":
                    ...
                    break;
                case "itemid":
                    if (!(reader["ItemId"] is DBNull))
                        entity.ItemId = Convert.ToInt32(reader["ItemId"]);
                    break;
            }
        }
        return entity;
