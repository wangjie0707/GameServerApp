...
/// DBModel
/// </summary>
public partial class RechargeRecordDBModel : MFAbstractSQLDBModel<RechargeRecordEntity>
{
    #region RechargeRecordDBModel 私有构造
    /// <summary>
    /// 私有构造
    /// </summary>
    private RechargeRecordDBModel()
    {
    ...
    private static RechargeRecordDBModel instance = null;
    public static RechargeRecordDBModel Instance
    {
        get
        {
            if (instance == null)
            {
                lock (lock_object)
                {
                    if (instance == null)
                    {
                        instance = new RechargeRecordDBModel();
                    }
                }
            }
            return instance;
    ...
    protected override IList<string> ColumnList
    {
        get
        {
            if (_ColumnList == null)
            {
                _ColumnList = new List<string> { "Id", "Status", "RoleId", "ProductId", "CreateTime", "UpdateTime" };
            }
            return _ColumnList;
        }
    }
    ...
    /// <returns></returns>
    protected override SqlParameter[] ValueParas(RechargeRecordEntity entity)
    {
    ...
    /// <returns></returns>
    protected override RechargeRecordEntity GetEntitySelfProperty(IDataReader reader, DataTable table)
    {
