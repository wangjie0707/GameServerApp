...
/// CacheModel
/// </summary>
public partial class Log_GoodsOutCacheModel : MFAbstractCacheModel
{
    #region Log_GoodsOutCacheModel 私有构造
    /// <summary>
    /// 私有构造
    /// </summary>
    private Log_GoodsOutCacheModel()
    {
    ...
    private static Log_GoodsOutCacheModel instance = null;
    public static Log_GoodsOutCacheModel Instance
    {
        get
        {
            if (instance == null)
            {
                lock (lock_object)
                {
                    if (instance == null)
                    {
                        instance = new Log_GoodsOutCacheModel();
                    }
                }
            }
            return instance;
    ...
    /// 数据模型层单例
    /// </summary>
    private Log_GoodsOutDBModel DBModel { get { return Log_GoodsOutDBModel.Instance; } }
    #endregion
    ...
    /// <returns></returns>
    public MFReturnValue<object> Create(Log_GoodsOutEntity entity)
    {
    ...
    /// <param name="id"></param>
    /// <returns></returns>
    public Log_GoodsOutEntity GetEntity(int? id)
    {
    ...
    /// <returns></returns>
    public Log_GoodsOutEntity GetEntity(string condition, bool isAutoStatus = true)
    {
    ...
    /// <returns></returns>
    public List<Log_GoodsOutEntity> GetList(string tableName = "", string columns = "*", string condition = "", string orderby = "Id", bool isDesc = true, bool isAutoStatus = true, bool isEfficient = false)
    {
    ...
    /// <param name="isEfficient"></param>
    /// <returns></returns>
    public MFReturnValue<List<Log_GoodsOutEntity>> GetPageList(string tableName = "", string columns = "*", string condition = "", string orderby = "Id", bool isDesc = true, int? pageSize = 20, int? pageIndex = 1, bool isAutoStatus = true, bool isEfficient = false)
    {
