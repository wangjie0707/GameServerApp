...
/// CacheModel
/// </summary>
public partial class RechargeRecordCacheModel : MFAbstractCacheModel
{
    #region RechargeRecordCacheModel 私有构造
    /// <summary>
    /// 私有构造
    /// </summary>
    private RechargeRecordCacheModel()
    {
    ...
    private static RechargeRecordCacheModel instance = null;
    public static RechargeRecordCacheModel Instance
    {
        get
        {
            if (instance == null)
            {
                lock (lock_object)
                {
                    if (instance == null)
                    {
                        instance = new RechargeRecordCacheModel();
                    }
                }
            }
            return instance;
    ...
    /// 数据模型层单例
    /// </summary>
    private RechargeRecordDBModel DBModel { get { return RechargeRecordDBModel.Instance; } }
    #endregion
    ...
    /// <returns></returns>
    public MFReturnValue<object> Create(RechargeRecordEntity entity)
    {
    ...
    /// <param name="id"></param>
    /// <returns></returns>
    public RechargeRecordEntity GetEntity(int? id)
    {
    ...
    /// <returns></returns>
    public RechargeRecordEntity GetEntity(string condition, bool isAutoStatus = true)
    {
    ...
    /// <returns></returns>
    public List<RechargeRecordEntity> GetList(string tableName = "", string columns = "*", string condition = "", string orderby = "Id", bool isDesc = true, bool isAutoStatus = true, bool isEfficient = false)
    {
    ...
    /// <param name="isEfficient"></param>
    /// <returns></returns>
    public MFReturnValue<List<RechargeRecordEntity>> GetPageList(string tableName = "", string columns = "*", string condition = "", string orderby = "Id", bool isDesc = true, int? pageSize = 20, int? pageIndex = 1, bool isAutoStatus = true, bool isEfficient = false)
    {
