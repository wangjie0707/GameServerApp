...
/// CacheModel
/// </summary>
public partial class Role_EquipCacheModel : MFAbstractCacheModel
{
    #region Role_EquipCacheModel 私有构造
    /// <summary>
    /// 私有构造
    /// </summary>
    private Role_EquipCacheModel()
    {
    ...
    private static Role_EquipCacheModel instance = null;
    public static Role_EquipCacheModel Instance
    {
        get
        {
            if (instance == null)
            {
                lock (lock_object)
                {
                    if (instance == null)
                    {
                        instance = new Role_EquipCacheModel();
                    }
                }
            }
            return instance;
    ...
    /// 数据模型层单例
    /// </summary>
    private Role_EquipDBModel DBModel { get { return Role_EquipDBModel.Instance; } }
    #endregion
    ...
    /// <returns></returns>
    public MFReturnValue<object> Create(Role_EquipEntity entity)
    {
    ...
    /// <param name="id"></param>
    /// <returns></returns>
    public Role_EquipEntity GetEntity(int? id)
    {
    ...
    /// <returns></returns>
    public Role_EquipEntity GetEntity(string condition, bool isAutoStatus = true)
    {
    ...
    /// <returns></returns>
    public List<Role_EquipEntity> GetList(string tableName = "", string columns = "*", string condition = "", string orderby = "Id", bool isDesc = true, bool isAutoStatus = true, bool isEfficient = false)
    {
    ...
    /// <param name="isEfficient"></param>
    /// <returns></returns>
    public MFReturnValue<List<Role_EquipEntity>> GetPageList(string tableName = "", string columns = "*", string condition = "", string orderby = "Id", bool isDesc = true, int? pageSize = 20, int? pageIndex = 1, bool isAutoStatus = true, bool isEfficient = false)
    {
