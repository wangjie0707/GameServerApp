...
namespace GameServerApp
{
    ...
    public class ClientSocket
    {
        ...
        //接收数据包的缓冲数据流
        private mmo_memotyStream m_ReceiveMS = new mmo_memotyStream();
                        ...
                        while (true)
                        {
                            ...
                            if (m_ReceiveMS.Length >= currFullMsgLen)
                            {
                                ...
                                if (newCrc == crc)
                                {
                                    ...
                                    using (mmo_memotyStream ms = new mmo_memotyStream(bufferNew))
                                    {
